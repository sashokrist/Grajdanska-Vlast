		...
		class FusionSC_Search extends Fusion_Element {
			...
			public static function get_element_defaults() {
				...
				return [
					...
					'border_width'                => $fusion_settings->get( 'form_border_width' ),
			...
			public function get_styles() {
				...
				if ( '' !== $this->args['border_width'] ) {
					$styles .= 'border-width: ' . $this->args['border_width'] . ';';
				}
			...
			[
				...
				'params'     => [
					...
					[
						...
						'description' => esc_attr__( 'Controls the border size of the search field. In pixels.', 'fusion-builder' ),
						'min'         => '0',
						'max'         => '50',
						'step'        => '1',
						'value'       => '',
						'default'     => $fusion_settings->get( 'form_border_width' ),
						'group'       => esc_html__( 'Design', 'fusion-builder' ),
					],
					[
						'type'        => 'colorpickeralpha',
