	...
	if ( ! class_exists( 'FusionSC_Menu' ) ) {
		...
		class FusionSC_Menu extends Fusion_Element {
				...
				foreach ( $this->dynamic_css as $selector => $values ) {
					...
					foreach ( $result as $result_selector => $result_values ) {
						if ( $result_values === $element ) {
							...
							if ( false === strpos( $selector, ':focus-within' ) && false === strpos( $result_selector, ':focus-within' ) ) {
			...
			protected function get_styles() {
				...
				// Font family.
				if ( ! $this->is_default( 'fusion_font_family_typography' ) ) {
					$selectors = [
					...
					$this->add_css_property( $selectors, 'font-family', $this->args['fusion_font_family_typography'] );
				}
				...
				// Font Weight.
				if ( ! $this->is_default( 'fusion_font_variant_typography' ) ) {
					$selectors = [
						$this->base_selector . ' .fusion-menu-element-list',
						$this->base_selector . ' .fusion-megamenu-wrapper .fusion-megamenu-holder .fusion-megamenu .fusion-megamenu-submenu .fusion-megamenu-title',
					];
					$this->add_css_property( $selectors, 'font-weight', $this->args['fusion_font_variant_typography'] );
				}
				...
				// Submenu font family.
				if ( ! $this->is_default( 'fusion_font_family_submenu_typography' ) ) {
					$selectors = [
						$this->base_selector . ' .fusion-menu-element-list .sub-menu > li',
						$this->base_selector . ' .fusion-menu-element-list .sub-menu li a',
					];
					$this->add_css_property( $selectors, 'font-family', $this->args['fusion_font_family_submenu_typography'] );
				}

				// Submenu font family.
				if ( ! $this->is_default( 'fusion_font_variant_submenu_typography' ) ) {
					$selectors = [
						$this->base_selector . ' .fusion-menu-element-list .sub-menu > li',
						$this->base_selector . ' .fusion-menu-element-list .sub-menu li a',
					];
					$this->add_css_property( $selectors, 'font-weight', $this->args['fusion_font_variant_submenu_typography'] );
				}
				...
				if ( ! $this->is_default( 'submenu_active_color' ) ) {
					...
					$selectors = [
						...
						$this->base_selector . ' .fusion-menu-element-list ul:not(.fusion-megamenu) > li.current-menu-item > a',
						$this->base_selector . ' .fusion-menu-element-list ul:not(.fusion-megamenu) > li.current-menu-ancestor > a',
						$this->base_selector . ' .fusion-menu-element-list ul:not(.fusion-megamenu) > li.current-menu-parent > a',
				...
				if ( ! $this->is_default( 'submenu_items_padding_right' ) ) {
					...
					if ( class_exists( 'WooCommerce' ) ) {
						$selectors[] = '.rtl' . $this->base_selector . ' .fusion-menu-cart-link';
						$selectors[] = '.ltr' . $this->base_selector . ' .fusion-menu-cart-checkout-link';
					}
					if ( 'flyout' === $this->args['submenu_mode'] ) {
				...
				if ( ! $this->is_default( 'submenu_items_padding_left' ) ) {
					...
					if ( class_exists( 'WooCommerce' ) ) {
						$selectors[] = '.rtl' . $this->base_selector . ' .fusion-menu-cart-checkout-link';
						$selectors[] = '.ltr' . $this->base_selector . ' .fusion-menu-cart-link';
					}
					if ( 'flyout' === $this->args['submenu_mode'] ) {
				...
				if ( ! $this->is_default( 'thumbnail_size_width' ) ) {
					$this->add_css_property( $this->base_selector . ':not(.collapse-enabled) a > .fusion-megamenu-image > img', 'width', $this->args['thumbnail_size_width'] );
				}
				if ( ! $this->is_default( 'thumbnail_size_height' ) ) {
					$this->add_css_property( $this->base_selector . ':not(.collapse-enabled) a > .fusion-megamenu-image > img', 'height', $this->args['thumbnail_size_height'] );
				}
				...
				if ( 'never' !== $this->args['breakpoint'] ) {
					...
					// Mobile font family.
					if ( ! $this->is_default( 'fusion_font_family_mobile_typography' ) ) {
						$selectors = [
						...
						$this->add_css_property( $selectors, 'font-family', $this->args['fusion_font_family_mobile_typography'] );
					}

					// Mobile font weight.
					if ( ! $this->is_default( 'fusion_font_variant_mobile_typography' ) ) {
						$selectors = [
							$this->base_selector . '.collapse-enabled',
							$this->base_selector . '.collapse-enabled ul li > a',
							$this->base_selector . '.collapse-enabled ul li > a .fusion-button',
						...
						$this->add_css_property( $selectors, 'font-weight', $this->args['fusion_font_variant_mobile_typography'] );
					}
				}
