...
function fusion_element_front_options_loop( $params ) {
	...
	function fusion_display_option( param ) {
		...
		#>
		<li data-option-id="{{ param.param_name }}" data-option-type="{{ param.type }}" class="fusion-builder-option {{ param.type }}{{ hidden }}{{ childDependency }}{{tabGroup}} {{optionMap}}{{escape_html}} {{responsiveState}}" data-dynamic="{{ hasDynamic }}" data-dynamic-selection="false">
