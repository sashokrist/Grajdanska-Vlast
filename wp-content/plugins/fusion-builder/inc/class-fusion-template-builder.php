...
class Fusion_Template_Builder {
	...
	public function render_content( $override = false ) {
		...
		if ( $post_object ) {
			...
			$this->remove_third_party_the_content_changes();
			...
			$this->readd_third_party_the_content_changes();
	 ...
	 * @return void
	 */
	public function remove_third_party_the_content_changes() {
	 ...
	 * @return void
	 */
	public function readd_third_party_the_content_changes() {
